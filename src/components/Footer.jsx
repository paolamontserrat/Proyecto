...
const Footer = () => {
  return (
    <footer className="bg-sky-50 py-6 px-4 mt-8 border-t-2 border-alianza-amarillo text-[10px] md:text-xs">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6 items-center">
        ...
        <div className="text-blue-900 font-bold leading-tight text-center md:text-left">
          ...
          <p className="mt-1 font-normal text-[9px]">
        ...
        <div className="flex flex-col gap-2 items-center md:items-start">
          ...
          >
            ...
            <span className="font-bold text-blue-900">Caja Popular Cerano</span>
          </a>
          ...
          >
            ...
            <span className="font-bold text-blue-900">cajapopularcerano</span>
          </a>
          ...
          <a 
            ...
            className="flex items-center gap-2 hover:scale-105 transition-transform"
          >
            <img src="/images/Youtube.png" className="h-20 md:h-15 object-contain ml-2" />
            <span className="font-bold text-blue-900">Caja Popular Cerano Alianza</span>
          </a>
